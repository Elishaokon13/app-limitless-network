import { ChainId, BASE_BSC_SCAN_URLS as DEFAULT_BASE_BSC_SCAN_URLS } from 'sdk'
import { BIG_TEN } from 'utils/bigNumber'

export const BASE_BSC_SCAN_URLS = DEFAULT_BASE_BSC_SCAN_URLS
...
export const CAKE_PER_BLOCK = 0.1
export const BLOCKS_PER_YEAR = (60 / BSC_BLOCK_TIME) * 60 * 24 * 365 // 10512000
export const CAKE_PER_YEAR = CAKE_PER_BLOCK * BLOCKS_PER_YEAR
export const BASE_URL = 'https://limitlessnetwork.org'
