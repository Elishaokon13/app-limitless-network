import { Currency, currencyEquals, WETH, ETHER } from 'sdk'
      ...
      return {
        ...
        execute:
          sufficientBalance && inputAmount
            ? async () => {
                try {
                  ...
                  addTransaction(txReceipt, {
                    summary: `Wrap ${inputAmount.toSignificant(6)} ${ETHER[chainId].symbol} to ${WETH[chainId].symbol}`,
                  })
                } catch (error) {
            ...
            : undefined,
        inputError: sufficientBalance ? undefined : t(`Insufficient ${ETHER[chainId].symbol} balance`),
      }
    }
      ...
      return {
        ...
        execute:
          sufficientBalance && inputAmount
            ...
            : undefined,
        inputError: sufficientBalance ? undefined : t(`Insufficient ${WETH[chainId].symbol} balance`),
      }
    }
