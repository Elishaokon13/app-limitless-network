...
export const updateUserSlippageConfirm = createAction<{ userSlippageConfirm: boolean }>(
  'user/updateUserSlippageConfirm',
)
export const updateUserUnvettedTokenConfirm = createAction<{ userUnvettedTokenConfirm: boolean }>(
  'user/updateUserUnvettedTokenConfirm',
)
export const updateUserTermsOfUseConfirm = createAction<{ userTermsOfUseConfirm: boolean }>(
  'user/updateUserTermsOfUseConfirm',
)
export const updateUserLiquidityDevConfirm = createAction<{ userLiquidityDevConfirm: boolean }>(
  'user/updateUserLiquidityDevConfirm',
)
...
export const updateGasPrice = createAction<{ gasType: string; chainId: ChainId }>('user/updateGasPrice')
...
export const setShowAccountDomain = createAction<boolean>('user/setShowAccountDomain')
export const togglePinToken = createAction<{ chainId: ChainId; address: string }>('global/togglePinToken')
