...
export const updateProtocolDividendTransactions = createAction<{ dtransactions: DividendTransaction[] }>(
  'info/protocol/updateProtocolDividendTransactions',
)
export const updateProtocolDividendChartData = createAction<{ dividendChartData: DividendChartEntry[] }>(
  'info/protocol/updateProtocolDividendChartData',
)
...
export const addTopTokensByChain = createAction<{ topTokens: TopTokensWithVolume[]; chainId: number }>(
  'info/tokens/addTopTokensByChain',
)
